...
function Counter2() {
    ...
    return (
        <div className={s.counter2}>
            <InstallValues error={error}  activateCounter= {activateCounter} setMinLocal={setMinLocal} setMaxLocal={setMaxLocal} min={min} max={max} setMaxMin={setMinMax} display={displays}/>
